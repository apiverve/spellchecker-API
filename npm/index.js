...
class spellcheckerWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/spellchecker');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/spellchecker';
    }
        ...
        if (requiredParams.length > 0) {
            for (var i = 0; i < requiredParams.length; i++) {
                if (!query[requiredParams[i]]) {
                    throw new Error(`Required parameter [${requiredParams[i]}] is missing. See documentation: https://docs.apiverve.com/ref/spellchecker`);
                }
            }
        }
...
module.exports = spellcheckerWrapper;
